...
const k = (e) => (P("data-v-14d60815"), e = e(), U(), e), A = { key: 0 }, G = ["placeholder"], J = { key: 1 }, Q = ["placeholder", "rows", "cols"], R = {
  key: 2,
  class: "search"
}, X = ["placeholder"], Y = {
  key: 3,
  ...
  key: 4,
  class: "cache-search"
}, se = ["placeholder", "onKeyup"], le = /* @__PURE__ */ k(() => /* @__PURE__ */ l("img", { src: "https://img1.imgtp.com/2023/02/12/mKWB4ns6.png" }, null, -1)), oe = [
  le
], ce = /* @__PURE__ */ k(() => /* @__PURE__ */ l("br", null, null, -1)), ae = {
  key: 0,
  class: "cache-search-title"
}, ue = /* @__PURE__ */ k(() => /* @__PURE__ */ l("div", { class: "cache-search-title-history" }, "搜索历史", -1)), ie = {
  key: 1,
  class: "cache-search-list"
}, re = ["onClick"], de = {
  key: 2,
  class: "cache-search-list"
}, he = ["onClick"], pe = /* @__PURE__ */ z({
  __name: "main",
  props: {
    placeholder: { default: "" },
  ...
  setup(e) {
    const p = e, a = h(!0), i = h("");
    let r = h([]), m = h([]), v = "https://img1.imgtp.com/2023/02/12/86q3pyMC.png", x = "https://img1.imgtp.com/2023/02/12/5lVT5sTv.png";
    const f = h(v), I = h(null);
    M(() => {
      const t = I.value;
    ...
    function T() {
      ...
      if (s !== 0)
        for (const n of r.value)
          n.length >= s && n.substring(0, s) === t && m.value.push([t, n.substring(s)]);
    }
    function H() {
      setTimeout(() => {
    ...
    function F() {
      ...
      f.value === v ? (f.value = x, t && (t.type = "password")) : (f.value = v, t && (t.type = "text"));
    }
    return (t, s) => (o(), c(y, null, [
      ...
      e.type === "cache-search" ? (o(), c("div", ne, [
        ...
        a.value && u(m).length > 0 && i.value ? (o(), c("div", de, [
          (o(!0), c(y, null, S(u(m), (n, g) => (o(), c("div", {
            key: g,
            onClick: (K) => C(n[0] + n[1])
          }, [
            l("p", null, _(n[0]), 1),
...
const me = (e, p) => {
  ...
  for (const [i, r] of p)
    a[i] = r;
  return a;
}, fe = /* @__PURE__ */ me(pe, [["__scopeId", "data-v-14d60815"]]), ge = {
  install(e) {
    e.component("Input", fe);
  }
};
export {
  ge as default
