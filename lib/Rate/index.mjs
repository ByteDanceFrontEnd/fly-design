import { ref as cl, defineComponent as c0, useCssVars as h0, useSlots as g0, openBlock as Ei, createElementBlock as Ti, createElementVNode as Li, Fragment as _0, renderList as p0, normalizeClass as hl, unref as on, normalizeStyle as gl, renderSlot as _l, createCommentVNode as v0 } from "vue";
var se = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ir = {}, d0 = {
  get exports() {
    return ir;
  },
  set exports(G) {
...
`) + v + `return __p
      ...
      var f0 = ze(function(n, t) {
        return n * t;
      }, 1), l0 = ei("round"), o0 = ze(function(n, t) {
        return n - t;
      }, 0);
      function s0(n) {
...
const x0 = { class: "wrap" }, A0 = ["onMouseenter", "onClick"], S0 = ["onMouseenter", "onClick"], R0 = /* @__PURE__ */ c0({
  __name: "Rate",
  props: {
  ...
  setup(G, { emit: Un }) {
    ...
    const Dn = g0();
    console.log(Dn);
    const { starNum: J, setStarNum: ft, overStarNum: Z, setOverStarNum: lt } = w0(
      l.modelValue,
      l.allowClear,
      l.disabled,
      () => {
...
const I0 = (G, Un) => {
  ...
  for (const [Dn, J] of Un)
    l[Dn] = J;
  return l;
}, y0 = /* @__PURE__ */ I0(R0, [["__scopeId", "data-v-e2f30091"]]), C0 = {
  install(G) {
    G.component("Rate", y0);
  }
};
