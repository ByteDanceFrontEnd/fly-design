...
const Ki = (h) => (N_("data-v-c6b52e30"), h = h(), W_(), h), Lp = { key: 0 }, Sp = ["placeholder"], Rp = { key: 1 }, Tp = ["placeholder", "rows", "cols"], Ep = {
  key: 2,
  class: "search"
}, Dp = ["placeholder"], Op = {
  key: 3,
...
const Zp = /* @__PURE__ */ Mn(Kp, [["__scopeId", "data-v-c6b52e30"]]), qp = {
  install(h) {
